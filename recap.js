/**
 * 1. how to use ja with html and css
 * 2. get element or elements from dom
 * 2-1: getElementById
 * 2-2: getRlementsByClassName
 * 2-3: queryselector
 * 2-4: queryselectorAll
 * 
 * 
 * 3. dynamically and elementto the dom: document.createElement
 ...
 * 
 * 5. addd event lister (event handler )
 * 5-1: click, focus, blur, onchange, keyup
 * 5-2: addEbentlistener onclick = "myHandler()"
 * 
 * 6. use function to reduce duplicae code
 * 
 * 7. event delegate 
 * 
 * */ 
